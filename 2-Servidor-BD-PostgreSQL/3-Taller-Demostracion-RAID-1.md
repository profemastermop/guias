...
# Implementación y Puesta en Producción: RAID 1
...
Asignar dos tarjetas de red: - NAT - Solo Anfitrión
...
-   **1 disco de 10G** para el Sistema Operativo
    ...
    -   4G → /
    -   resto → /home
-   **1 disco de 20G** para uso del RAID-1
-   **1 disco de 30G** para uso del RAID-1
...
Una vez finalizada la instalación, nos conectamos por medio de una
terminal (MobaXterm) y ejecutamos el siguiente comando:
...
1.  Eliminar la conexión del disco duro de **30G** del arreglo
2.  Observar el comportamiento en las terminales de MobaXterm
3.  Analizar los cambios en el estado del RAID
...
Observar nuevamente desde las terminales de MobaXterm:
